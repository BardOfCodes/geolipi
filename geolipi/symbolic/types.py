...
BASE_COMBINATORS = type_union[Union, Intersection, Difference, Complement, SwitchedDifference]
...
GENERAL_PARAM_SYM = type_union[RotationSymmetry2D, RotationSymmetry3D, TranslationSymmetry2D,
                               TranslationSymmetry3D, ScaleSymmetry2D, ScaleSymmetry3D]
...
PREFIXED_AXIS_SYM = type_union[TranslationSymmetryX2D, TranslationSymmetryY2D, TranslationSymmetryX3D,
                               TranslationSymmetryY3D, TranslationSymmetryZ3D,
...
TRANSSYM_TYPE = type_union[TranslationSymmetryX2D, TranslationSymmetryY2D, TranslationSymmetryX3D,
                           TranslationSymmetryY3D, TranslationSymmetryZ3D,
